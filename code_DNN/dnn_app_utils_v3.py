...
def L_nn_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000):
    np.random.seed(1)
    costs = []
...
parameters, cost = L_nn_model(train_x, train_y, layer_dims, num_iterations = 2500)

plt.figure("cost-iterations")
